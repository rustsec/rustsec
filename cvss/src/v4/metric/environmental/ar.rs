...
impl MetricV4 for AvailabilityRequirements {
    const TYPE: MetricTypeV4 = MetricTypeV4::AR;
...
pub(crate) mod merge {
    ...
    impl MetricV4Level for MergedAvailabilityRequirements {
        fn level(self) -> f64 {
