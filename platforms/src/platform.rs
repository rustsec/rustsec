...
impl Platform {
    ...
    pub fn all() -> &'static [Platform] {
        &[
            // Tier 1
            tier1::AARCH64_UNKNOWN_LINUX_GNU,
            ...
            tier2::AARCH64_UNKNOWN_NONE,
            tier2::AARCH64_UNKNOWN_NONE_SOFTFLOAT,
            ...
            tier2::ARMV5TE_UNKNOWN_LINUX_MUSLEABI,
            tier2::ARMV7_LINUX_ANDROIDEABI,
            tier2::ARMV7_UNKNOWN_LINUX_GNUEABI,
            tier2::ARMV7_UNKNOWN_LINUX_GNUEABIHF,
            tier2::ARMV7_UNKNOWN_LINUX_MUSLEABI,
            tier2::ARMV7_UNKNOWN_LINUX_MUSLEABIHF,
            tier2::ARMEBV7R_NONE_EABI,
            tier2::ARMEBV7R_NONE_EABIHF,
            ...
            tier2::MIPS64_UNKNOWN_LINUX_MUSLABI64,
            tier2::MIPS64EL_UNKNOWN_LINUX_GNUABI64,
            tier2::MIPS64EL_UNKNOWN_LINUX_MUSLABI64,
            tier2::MIPSEL_UNKNOWN_LINUX_GNU,
            tier2::MIPSEL_UNKNOWN_LINUX_MUSL,
            tier2::NVPTX64_NVIDIA_CUDA,
            ...
            tier2::THUMBV6M_NONE_EABI,
            tier2::THUMBV7EM_NONE_EABI,
            tier2::THUMBV7EM_NONE_EABIHF,
            tier2::THUMBV7M_NONE_EABI,
            tier2::THUMBV7NEON_LINUX_ANDROIDEABI,
            tier2::THUMBV7NEON_UNKNOWN_LINUX_GNUEABIHF,
            tier2::WASM_UNKNOWN_UNKNOWN,
            tier2::WASM_UNKNOWN_EMSCRIPTEN,
            tier2::WASM_WASI,
            tier2::X86_64_APPLE_IOS,
            tier2::X86_64_FORTANIX_UNKNOWN_SGX,
            tier2::X86_64_LINUX_ANDROID,
            tier2::X86_64_PC_SOLARIS,
            tier2::X86_64_UNKNOWN_FREEBSD,
            tier2::X86_64_FUCHSIA,
            tier2::X86_64_UNKNOWN_ILLUMOS,
            ...
            // Tier 3
            tier3::AARCH64_APPLE_IOS_MACABI,
            tier3::AARCH64_APPLE_IOS_SIM,
            tier3::AARCH64_APPLE_TVOS,
            tier3::AARCH64_UNKNOWN_FREEBSD,
            tier3::AARCH64_UNKNOWN_HERMIT,
            tier3::AARCH64_UNKNOWN_LINUX_GNU_ILP32,
            tier3::AARCH64_UNKNOWN_NETBSD,
            tier3::AARCH64_UNKNOWN_OPENBSD,
            tier3::AARCH64_UNKNOWN_REDOX,
            tier3::AARCH64_UWP_WINDOWS_MSVC,
            tier3::AARCH64_WRS_VXWORKS,
            tier3::AARCH64_BE_UNKNOWN_LINUX_GNU_ILP32,
            tier3::AARCH64_BE_UNKNOWN_LINUX_GNU,
            tier3::ARMV4T_UNKNOWN_LINUX_GNUEABI,
            tier3::ARMV5T_UNKNOWN_LINUX_UCLIBCEABI,
            tier3::ARMV6_UNKNOWN_FREEBSD,
            tier3::ARMV6_UNKNOWN_NETBSD_EABIHF,
            tier3::ARMV7_APPLE_IOS,
            tier3::ARMV7_UNKNOWN_FREEBSD,
            tier3::ARMV7_UNKNOWN_NETBSD_EABIHF,
            tier3::ARMV7_WRS_VXWORKS_EABIHF,
            tier3::ARMV7A_NONE_EABIHF,
            tier3::ARMV7S_APPLE_IOS,
            tier3::I386_APPLE_IOS,
            tier3::I686_APPLE_DARWIN,
            tier3::I686_UNKNOWN_HAIKU,
            tier3::I686_UNKNOWN_NETBSD,
            tier3::I686_UNKNOWN_OPENBSD,
            ...
            tier3::S390X_UNKNOWN_LINUX_MUSL,
            tier3::SPARC64_UNKNOWN_NETBSD,
            tier3::X86_64_SUN_SOLARIS,
